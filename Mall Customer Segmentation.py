...
#Visualization of the range of distribution range of spending score and annual income range
...
#Within Cluster Sum Of Squares (WCSS) against the the number of clusters (K values)
...
# # ELBOW METHOD
# 
# Within Cluster Sum of Squared Errors (WSS) for different values of k are calculated , and the k for which WSS first starts to diminish is chosen. In the plot of WSS-versus k, this is visible as an elbow.
